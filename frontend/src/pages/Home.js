...
const Home = () => {
  ...
  <img src={Logo} alt="IEEE Logo" className="w-2/3 md:w-2/3 h-auto" />
</div>
          ...
          {/* Contact Form */}
          <div className="glass rounded-3xl px-6 md:p-12 mx-auto max-w-2xl flex flex-col items-center text-white">
            ...
            <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5">
              ...
              {/* Glass-styled select: uses a hidden input so FormData still includes the value */}
              <GlassSelect
                name="category"
                required
  ...
  className="w-full px-6 py-3 mt-4 
             ...
             rounded-2xl shadow-[0_0_12px_rgba(239,68,68,0.5)] 
             shadow-none hover:shadow-[0_0_20px_rgba(255,255,255,0.04)]
