    ...
    <div className="relative min-h-screen">
      ...
      <section className="relative z-10 min-h-screen flex items-center justify-center px-4 md:px-6 pt-32 md:pt-40">
        <div className="max-w-6xl mx-auto text-center">
          {/* Main Glass Box */}
          <div className="glass rounded-3xl p-8 md:p-12 mb-8 mt-16 backdrop-blur-xl bg-white/10 border border-white/20 shadow-lg">
            <img
              src={Logo}
              alt="ImpactX Logo"
            ...
            <div className="mb-8">
              <div className="inline-block glass rounded-2xl p-6 border-2 border-red-500/50 glow-red mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-8">
              <Link to="/impactx-register" className="w-full md:w-1/2">
                <GlassButton
                  variant="primary"
                  size="lg"
                  className="w-full text-lg py-4 rounded-3xl flex items-center justify-center"
                >
            ...
            {/* Quick Stats */}
            <div className="glass rounded-3xl p-6 border border-white/20 shadow-lg mt-8">
